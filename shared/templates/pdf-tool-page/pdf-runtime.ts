...
// ZIP writer moved to ./zip-archive (2026-07-06) so light consumers
// (lib/ooxml-translate + its node tests) don't drag in this module's heavy
// top-level imports. Re-exported here so existing callers keep working;
// the local import keeps this module's own three call sites bound.
