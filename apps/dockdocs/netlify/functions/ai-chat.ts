      ...
      return json(
        {
          ...
          message: pick(locale, {
            ...
            de: "Der Chat-with-PDF-Anbieter hat nicht das erwartete strukturierte Antwort-JSON zurückgegeben.",
            ko: "Chat with PDF 제공업체가 예상한 구조화된 답변 JSON을 반환하지 않았습니다.",
            "zh-Hant": "Chat with PDF 服務未回傳預期的結構化回答 JSON。",
          }),
          httpStatus: 502,
          diagnostics: {
