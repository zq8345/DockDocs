    ...
    return json(
      {
        ...
        message: pick(locale, {
          ...
          de: "Es ist nicht genügend Text zum Zusammenfassen vorhanden. Extrahieren Sie mehr PDF-Text oder führen Sie zuerst OCR aus.",
          ko: "요약할 텍스트가 충분하지 않습니다. PDF에서 텍스트를 더 추출하거나 먼저 OCR을 실행하세요.",
          "zh-Hant": "可用於摘要的文字太少。請先從 PDF 擷取更多文字或執行 OCR。",
        }),
        httpStatus: 400,
      },
      200,
    ...
    return json(
      {
        ...
        message: pick(locale, {
          ...
          de: "AI Summary unterstützt derzeit bis zu 24.000 Zeichen. Kürzen Sie den Text und versuchen Sie es erneut.",
          ko: "AI Summary는 현재 최대 24,000자를 지원합니다. 텍스트를 줄여서 다시 시도하세요.",
          "zh-Hant": "AI Summary 目前最多支援 24,000 字。請縮短文字後重試。",
        }),
        httpStatus: 413,
      },
      200,
      ...
      return json(
        {
          ...
          message: pick(locale, {
            ...
            de: "Der AI-Summary-Anbieter hat nicht das erwartete strukturierte Zusammenfassungs-JSON zurückgegeben.",
            ko: "AI Summary 제공업체가 예상한 구조화된 요약 JSON을 반환하지 않았습니다.",
            "zh-Hant": "AI Summary 服務未回傳預期的結構化摘要 JSON。",
          }),
          httpStatus: 502,
        },
        200,
        ...
        message: pick(
          ...
          timedOut
            ? {
                ...
                de: "Der AI-Summary-Anbieter hat das Zeitlimit überschritten oder war nicht erreichbar.",
                ko: "AI Summary 제공업체의 응답 시간이 초과되었거나 연결할 수 없습니다.",
                "zh-Hant": "AI Summary 服務逾時或無法連線。",
              }
            : {
                ...
                de: "Der AI-Summary-Anbieter konnte die Anfrage nicht abschließen. Bitte versuchen Sie es erneut.",
                ko: "AI Summary 제공업체가 요청을 완료하지 못했습니다. 다시 시도해 주세요.",
                "zh-Hant": "AI Summary 服務無法完成請求。請重試。",
              },
        ),
