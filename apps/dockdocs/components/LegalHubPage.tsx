  ...
  copy: {
    en: {
      ...
      cards: [
        ...
        { slug: "contract-review", label: "Contract Version Compare", description: "See what changed between two contract versions, clause by clause — AI-powered change cards with source quotes from both documents." },
      ],
    ...
    zh: {
      ...
      heroDescription:
        "六个专注的工具，读懂合同、租约或招标文件，帮你抓住要点——风险条款、缺失的保护、合规要求，以及两版之间改了什么。能引用到原文的结论都附上你文件里的原文，缺失类条款则明确标注，让你在行动前逐条核对。",
      primary: "体检一份合同",
      secondary: "扫描一份租约",
      cardsTitle: "法律团队工具",
      cards: [
        ...
        { slug: "contract-review", label: "合同版本对比", description: "逐条查看两个合同版本之间发生了哪些变化——AI 生成的变更卡片，附双版原文引用。" },
      ],
    ...
    es: {
      ...
      heroDescription:
        "Seis herramientas centradas que leen un contrato, arrendamiento o pliego y destacan lo que importa: cláusulas riesgosas, protecciones ausentes, requisitos de cumplimiento y qué cambió entre versiones. Los hallazgos que pueden citarse muestran el pasaje exacto de tu documento, y las protecciones ausentes se señalan como faltantes, para que puedas verificar lo que hay antes de actuar.",
      ...
      cards: [
        ...
        { slug: "contract-review", label: "Comparación de versiones de contrato", description: "Ve qué cambió entre dos versiones de un contrato, cláusula por cláusula — cambios con IA y citas del texto original de ambos documentos." },
      ],
    ...
    pt: {
      ...
      heroDescription:
        "Seis ferramentas focadas que leem um contrato, locação ou edital e destacam o que importa: cláusulas arriscadas, proteções ausentes, requisitos de conformidade e o que mudou entre versões. Os achados que podem ser citados mostram o trecho exato do seu documento, e as proteções ausentes são marcadas como faltantes, para que você possa verificar o que há antes de agir.",
      ...
      cards: [
        ...
        { slug: "contract-review", label: "Comparação de versões do contrato", description: "Veja o que mudou entre duas versões de um contrato, cláusula por cláusula — cards de mudança com IA e citações do texto original de ambos os documentos." },
      ],
    ...
    fr: {
      ...
      cards: [
        ...
        { slug: "contract-review", label: "Comparaison de versions du contrat", description: "Voyez ce qui a changé entre deux versions d'un contrat, clause par clause — modifications par IA avec citations du texte source des deux documents." },
      ],
    ...
    ja: {
      ...
      heroDescription:
        "契約書、賃貸借契約、入札仕様書を読み込み、重要なポイントを浮かび上がらせる6つの特化ツール——リスクのある条項、不足している保護、コンプライアンス要件、そしてバージョン間で何が変わったか。引用できる指摘にはあなたの文書の該当箇所を示し、欠けている保護条項は「欠落」と明示するため、行動する前に存在するものを確認できます。",
      primary: "契約書をチェック",
      ...
      cards: [
        ...
        { slug: "contract-review", label: "契約書バージョン比較", description: "2 つの契約書バージョン間の変更点を条項ごとに確認 — AI が変更カードを生成し、両文書の引用を付与します。" },
      ],
    ...
    de: {
      ...
      cards: [
        ...
        { slug: "contract-review", label: "Vertragsversionenvergleich", description: "Sehen Sie, was sich zwischen zwei Vertragsversionen geändert hat, Klausel für Klausel — KI-gestützte Änderungskarten mit Quelltextzitaten aus beiden Dokumenten." },
      ],
    ...
    ko: {
      ...
      heroDescription:
        "계약서·임대차 계약·입찰 문서를 읽고 핵심을 짚어 주는 여섯 가지 전문 도구입니다 — 위험 조항, 빠진 보호 장치, 규정 준수 요건, 그리고 두 버전 사이에 바뀐 점까지. 문서에서 인용할 수 있는 결과는 정확한 구절을 보여 주고, 빠진 보호 장치는 「누락」으로 표시하므로, 행동하기 전에 무엇이 있는지 확인할 수 있습니다.",
      primary: "계약서 검토",
      secondary: "임대차 계약 스캔",
      ...
      cards: [
        ...
        { slug: "contract-review", label: "계약서 버전 비교", description: "두 계약서 버전 사이에 무엇이 바뀌었는지 조항별로 확인 — AI가 변경 카드를 생성하고 양쪽 문서에서 원문을 인용합니다." },
      ],
