...
// pdf-to-excel, ai-summary, compare). The page adds no gate
  ...
  copy: {
    en: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "Batch Extract to Sheet", description: "Drop a whole batch of invoices or receipts and get one combined spreadsheet, extracted automatically." },
    ...
    zh: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "批量抽取到表格", description: "整批丢进发票或收据，自动抽取并汇成一张表格。" },
    ...
    es: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "Extracción por lotes a hoja", description: "Suelta un lote completo de facturas o recibos y obtén una sola hoja de cálculo combinada, extraída automáticamente." },
    ...
    pt: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "Extração em lote para planilha", description: "Solte um lote inteiro de faturas ou recibos e receba uma única planilha combinada, extraída automaticamente." },
    ...
    fr: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "Extraction par lot vers tableur", description: "Déposez tout un lot de factures ou de reçus et obtenez un seul tableur combiné, extrait automatiquement." },
    ...
    ja: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "シートに一括抽出", description: "請求書や領収書をまとめて投入すると、自動で抽出して 1 枚の表計算シートにまとめます。" },
    ...
    de: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "Stapel-Extraktion in Tabelle", description: "Laden Sie einen ganzen Stapel Rechnungen oder Belege hoch und erhalten Sie eine einzige kombinierte Tabelle, automatisch extrahiert." },
    ...
    ko: {
      ...
      cards: [
        ...
        { slug: "extract-to-excel", label: "시트로 일괄 추출", description: "청구서나 영수증을 한꺼번에 올리면 자동으로 추출해 하나의 스프레드시트로 합쳐 줍니다." },
