...
const financeConfig: VerticalConfig = {
  ...
  copy: {
    en: {
      ...
      heroDescription:
        "Pull the numbers out of invoices, receipts, and statements into a spreadsheet, summarize long financial reports, and compare quotes side by side — every figure shows the line it came from, so you can check it before it reaches your books.",
      primary: "Extract to a spreadsheet",
      secondary: "Summarize a report",
      cardsTitle: "Tools for finance teams",
      cards: [
        { slug: "extract-to-excel", label: "Extract to Excel", description: "Turn invoices, receipts, and statements into a spreadsheet — AI pulls the key fields and shows the source line behind each value." },
    ...
    zh: {
      ...
      heroDescription:
        "把发票、收据、对账单里的数字抽成表格，浓缩冗长的财务报告，并排比较多份报价——每个数字都标出它出自的那一行，让你在录入账目前能逐项核对。",
      primary: "抽取成表格",
      secondary: "摘要一份报告",
      cardsTitle: "财务团队工具",
      cards: [
        { slug: "extract-to-excel", label: "数据抽取到表格", description: "把发票、收据、对账单抽成表格——AI 提取关键字段，并标出每个值背后的原文出处。" },
    ...
    es: {
      ...
      heroDescription:
        "Extrae los números de facturas, recibos y estados de cuenta a una hoja de cálculo, resume informes financieros extensos y compara presupuestos lado a lado — cada cifra muestra la línea de la que proviene, para que puedas verificarla antes de que llegue a tus libros.",
      primary: "Extraer a una hoja de cálculo",
      secondary: "Resumir un informe",
      cardsTitle: "Herramientas para equipos de finanzas",
      cards: [
        { slug: "extract-to-excel", label: "Extraer a Excel", description: "Convierte facturas, recibos y estados de cuenta en una hoja de cálculo — la IA extrae los campos clave y muestra la línea de origen de cada valor." },
    ...
    pt: {
      ...
      heroDescription:
        "Extraia os números de faturas, recibos e extratos para uma planilha, resuma relatórios financeiros longos e compare orçamentos lado a lado — cada valor mostra a linha de onde veio, para que você possa conferi-lo antes de lançá-lo na contabilidade.",
      primary: "Extrair para uma planilha",
      secondary: "Resumir um relatório",
      cardsTitle: "Ferramentas para equipes financeiras",
      cards: [
        { slug: "extract-to-excel", label: "Extrair para Excel", description: "Transforme faturas, recibos e extratos em uma planilha — a IA extrai os campos-chave e mostra a linha de origem de cada valor." },
    ...
    fr: {
      ...
      heroDescription:
        "Extrayez les chiffres des factures, reçus et relevés vers un tableur, résumez de longs rapports financiers et comparez des devis côte à côte — chaque montant indique la ligne dont il provient, pour que vous puissiez le vérifier avant qu'il n'entre dans vos comptes.",
      primary: "Extraire vers un tableur",
      secondary: "Résumer un rapport",
      cardsTitle: "Outils pour les équipes financières",
      cards: [
        { slug: "extract-to-excel", label: "Extraire vers Excel", description: "Transformez factures, reçus et relevés en tableur — l'IA extrait les champs clés et indique la ligne source de chaque valeur." },
