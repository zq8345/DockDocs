...
const FAQS_JA: Record<string, { title: string; items: Array<{ q: string; a: string }> }> = {
  "chat-with-pdf": {
    title: "PDF対話 — よくある質問",
    items: [
      { q: "どのように動作しますか？", a: "テキストベースのPDFをアップロードすると、DockDocs がブラウザ内でテキストを抽出します。あなたが質問すると、AIは一般的なウェブ知識ではなく、その文書の内容を使って回答します。これは絞り込んだMVPで、1度に1文書、1ファイルあたり最大12ページ／40,000文字／25 MBまでです。" },
      ...
      { q: "制限はありますか？", a: "MVPでは1ファイルあたり25 MB・12ページ・抽出テキスト40,000文字までです。長い文書は先に分割または圧縮してください。無料の1日あたりの利用枠があり、それ以上が必要な場合はアップグレードしてください。" },
    ],
  },
  "govbid-matrix": {
