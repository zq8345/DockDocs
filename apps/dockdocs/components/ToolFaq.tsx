...
const FAQS_JA: Record<string, { title: string; items: Array<{ q: string; a: string }> }> = {
  ...
  "compare": {
    title: "文書を比較 — よくある質問",
    items: [
      { q: "文書をどう比較しますか？", a: "同じ種類のPDF（見積・請求書・契約書）を2〜8件アップロードし、種類を選んで「項目を比較」をクリックします。DockDocs が主要な項目（価格・納期・支払い・保証など）を1つの表に横並びにし、各値の根拠となる原文の行も示します。どれが優れているかの根拠つき推奨も得られ、全文書に対して1つの質問もできます。" },
