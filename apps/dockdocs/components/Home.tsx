...
const COPY = {
  en: {
    ...
    proof: [{ t: "Processed in your browser" }, { g: "0", t: " files uploaded" }, { t: "AI shows its source — or says it can't" }, { t: "No sign-up" }],
    ...
    ctaSub: "~50 tools, AI that cites its source when it can, nothing uploaded. Free to start — no sign-up.",
  ...
  zh: {
    ...
    primary: "免费使用",
    secondary: "看隐私怎么做到",
    proof: [{ t: "在浏览器内处理" }, { g: "0", t: " 文件上传" }, { t: "答案标注出处，无法溯源会说明" }, { t: "无需注册" }],
    findEyebrow: "// 找到你的工具",
    ...
    ctaHeadA: "读懂任意文档，",
    ctaHeadB: "逐一核验答案。",
    ctaSub: "约 50 个工具，会尽量给你看依据的 AI，零上传。免费开始，无需注册。",
    viewPricing: "查看定价",
  ...
  es: {
    ...
    proof: [{ t: "Procesado en tu navegador" }, { g: "0", t: " archivos subidos" }, { t: "La IA cita su fuente, o avisa si no puede" }, { t: "Sin registro" }],
    ...
    ctaSub: "~50 herramientas, IA que cita su fuente cuando puede, nada se sube. Gratis para empezar — sin registro.",
  ...
  pt: {
    ...
    proof: [{ t: "Processado no seu navegador" }, { g: "0", t: " arquivos enviados" }, { t: "A IA cita a fonte, ou avisa quando não dá" }, { t: "Sem cadastro" }],
    ...
    ctaSub: "~50 ferramentas, IA que cita a fonte quando dá, nada é enviado. Grátis para começar — sem cadastro.",
  ...
  fr: {
    ...
    proof: [{ t: "Traité dans votre navigateur" }, { g: "0", t: " fichiers envoyés" }, { t: "L'IA cite sa source, ou le signale sinon" }, { t: "Sans inscription" }],
    ...
    ctaSub: "~50 outils, IA qui cite sa source quand elle le peut, rien n'est envoyé. Gratuit pour commencer — sans inscription.",
  ...
  ja: {
    ...
    proof: [{ t: "ブラウザ内で処理" }, { g: "0", t: " ファイルのアップロード" }, { t: "根拠を提示、無理なら明示" }, { t: "登録不要" }],
    findEyebrow: "// ツールを探す",
    ...
    ctaHeadB: "すべての回答を検証。",
    ctaSub: "約50のツール、可能な限り根拠を示すAI、アップロードなし。無料で開始——登録不要。",
    viewPricing: "料金を見る",
