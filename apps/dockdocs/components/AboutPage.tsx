...
const content = {
  ...
  ko: {
    ...
    doRows: ["브라우저에서 파일을 처리합니다", "클라우드 임시 파일을 즉시 삭제합니다", "모든 클라우드 단계를 미리 표시합니다", "AI 답변의 출처를 표시합니다 — 찾을 수 없을 때는 그렇다고 알립니다", "계정 없이 시작할 수 있게 합니다"],
    ...
    cloudSub: "일부 도구(Office 변환, 대용량 OCR, AI 채팅)는 서버가 필요합니다: 시작 전에 표시되고, 전송 중 암호화되며, 직후에 삭제됩니다. AI가 질문에 답하거나 발견한 점을 표시할 때는, 그 근거가 되는 정확한 구절을 보여 줍니다 — 당신의 파일에서 그대로 인용하고 실제로 거기에 있음을 확인합니다 — 그리고 출처를 만들어 내는 대신, 추적할 수 없을 때는 그렇다고 알립니다.",
