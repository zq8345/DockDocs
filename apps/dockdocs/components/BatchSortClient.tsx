...
const STR_en = {
  ...
  run: "Sort all", running: "Sorting", download: "Download sorted ZIP", reset: "Clear files", remove: "Remove",
...
const STR = {
  ...
  zh: {
    ...
    run: "全部分类", running: "分类中", download: "下载归档 ZIP", reset: "清空文件", remove: "移除",
  ...
  es: {
    ...
    run: "Ordenar todo", running: "Ordenando", download: "Descargar ZIP ordenado", reset: "Borrar archivos", remove: "Quitar",
  ...
  pt: {
    ...
    run: "Classificar tudo", running: "Classificando", download: "Baixar ZIP classificado", reset: "Limpar arquivos", remove: "Remover",
  ...
  fr: {
    ...
    run: "Tout classer", running: "Classement en cours", download: "Télécharger le ZIP classé", reset: "Vider la liste", remove: "Retirer",
  ...
  ja: {
    ...
    run: "すべて分類", running: "分類中", download: "分類済み ZIP をダウンロード", reset: "ファイルをクリア", remove: "削除",
  ...
  de: {
    ...
    run: "Alle sortieren", running: "Wird sortiert", download: "Sortiertes ZIP herunterladen", reset: "Liste leeren", remove: "Entfernen",
  ...
  ko: {
    ...
    run: "전체 분류", running: "분류 중", download: "분류된 ZIP 다운로드", reset: "파일 비우기", remove: "제거",
