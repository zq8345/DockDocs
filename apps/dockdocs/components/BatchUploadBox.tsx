      ...
      {busy ? (
        ...
        <>
          ...
          <div className="mt-1 flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-xs text-[color:var(--faint)]">
            <span>{hint ?? (locale === "zh" ? "支持 PDF" : locale === "zh-Hant" ? toHant("支持 PDF") : locale === "es" ? "Compatible con PDF" : locale === "pt" ? "Compatível com PDF" : locale === "fr" ? "Compatible PDF" : locale === "ja" ? "PDF対応" : locale === "de" ? "PDF wird unterstützt" : "Supports PDF")}</span>
            {privacyLabel !== null && (
              <>
