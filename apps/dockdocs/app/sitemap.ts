...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const standaloneContentRoutes = [
    ...
    {
      url: absoluteUrl("/dockdocs-vs-smallpdf/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.7,
    },
    {
      url: absoluteUrl("/dockdocs-vs-ilovepdf/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.7,
    },
    {
      url: absoluteUrl("/ai-contract-risk-analysis/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/private-pdf-ai/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/verifiable-document-ai/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/client-side-pdf-processing/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/ai-contract-review/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/sensitive-document-redaction/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/ai-due-diligence-document-review/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    ...
    {
      url: absoluteUrl("/watermark-pdf-without-uploading/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.7,
    },
    {
      url: absoluteUrl("/rotate-pdf-without-uploading/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.7,
    },
    ...
    {
      url: absoluteUrl("/lease-agreement-red-flags/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/compare-two-versions-of-a-document/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    ...
    {
      url: absoluteUrl("/employment-contract-red-flags/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/nda-what-to-look-for/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    {
      url: absoluteUrl("/vendor-contract-red-flags/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.75,
    },
    ...
    {
      url: absoluteUrl("/ai-contract-risk-for-legal-teams/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: absoluteUrl("/ai-document-workspace/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: absoluteUrl("/how-to-redline-a-contract/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: absoluteUrl("/service-agreement-red-flags/"),
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
