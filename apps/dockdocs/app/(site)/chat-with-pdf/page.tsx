...
export const metadata: Metadata = {
  ...
  description: "Chat with any PDF or document and get answers that show their source when it can be located — upload a file, ask questions, and let AI read it for you. Free, in your browser.",
