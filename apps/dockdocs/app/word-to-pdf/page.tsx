...
const config = {
  ...
  heroDescription: "Upload any Word document and download a pixel-perfect PDF in seconds. Fonts, tables, columns, and images are preserved. Powered by CloudConvert.",
