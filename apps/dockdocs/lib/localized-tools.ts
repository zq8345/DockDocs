...
const esFaq: Partial<Record<ToolSlug, { faqTitle: string; faq: Array<{ question: string; answer: string }> }>> = {
  "compress-pdf": {
    ...
    faq: [
      ...
      { question: "¿Puedo usarlo en el móvil?", answer: "Sí. Las páginas de DockDocs son adaptables para móvil y computadora." },
