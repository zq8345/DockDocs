...
const HOME_FAQ: Record<string, { q: string; a: string }[]> = {
  en: [
    ...
    { q: "Is DockDocs free to use?", a: "Yes. DockDocs core PDF tools — compress, merge, split, convert, OCR, and more — are completely free. No account required for most tools. Pro plan ($9/month) adds AI features like Chat with PDF, AI Summarization, and contract review." },
